...
*/
		...
		function getLocationAndWeather(){
			...
			*/
				...
				xhr.open("GET", "https://fourtonfish.com/tutorials/weather-web-app/getlocationandweather.php?owapikey=a3a9ecdf387c45fca37e780bd9e001c3&units=metric", true);
				xhr.send();
		...
		function getWeatherForLocation(){
			...
			if (location != null){
				...
				xhr.open("GET", "https://fourtonfish.com/tutorials/weather-web-app/getweatherforlocation.php?owapikey=a3a9ecdf387c45fca37e780bd9e001c3&units=metric&location=" + location, true);
				xhr.send();
			}
			else{
				alert("Unable to fetch the location and weather data.");
		...
		function loadBackground(lat, lon, weatherTag) {
			...
			script_element.src = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=35c0cbf1127c5f2d5abb98d2985e882c&lat=" + lat + "&lon=" + lon + "&accuracy=1&tags=" + weatherTag + "&sort=relevance&extras=url_l&format=json";
